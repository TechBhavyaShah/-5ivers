...
const updateFoodItemStock = async function updateFoodItemStock(
  ...
  if (stock == null || stock == undefined) {
    throw {
      message: "stock cannot be empty or undefined ",
      status: 400,
    };
  }
  ...
  if (!restaurantId || !itemId) {
    throw {
      message: "You must provide restaurant Id and Item Id of the Item ",
      status: 400,
    };
  }
  ...
  if (stock < 0) {
    throw {
      message: "The stock should be of positive. It cannot be negative",
      status: 400,
    };
  }
